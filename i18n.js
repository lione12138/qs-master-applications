...
export const I18N = {
  en: {
    ...
    sortBy: "Sort by", sortRank: "QS rank", sortOpenDate: "Opening date", sortDeadline: "Deadline",
  ...
  zh: {
    ...
    sortBy: "排序方式", sortRank: "QS 排名", sortOpenDate: "开放日期", sortDeadline: "截止日期",
    favoritesOnly: "仅看收藏", top100Only: "仅看 QS 前100", exportFavorites: "导出收藏截止日",
