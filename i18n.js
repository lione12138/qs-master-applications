...
export const I18N = {
  en: {
    ...
    favoritesOnly: "Favourites only", top100Only: "Top 100 only", exportFavorites: "Export favourite deadlines",
  ...
  zh: {
    ...
    favoritesOnly: "仅看收藏", top100Only: "仅看前100", exportFavorites: "导出收藏截止日",
