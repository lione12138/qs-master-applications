...
export const I18N = {
  en: {
    ...
    downloadIcs: "Download ICS calendar file", rank: "rank", university: "University", programme: "Programme", applicantGroup: "Applicant group",
    ...
    reviewSubmitButton: "Post comment", reviewPublicNote: "Comments are public. Do not post private contact details or sensitive information.", reviewAnonymous: "Anonymous",
  ...
  zh: {
    ...
    downloadIcs: "下载 ICS 日历文件", rank: "排名", university: "大学", programme: "项目", applicantGroup: "适用人群",
    ...
    reviewSubmitButton: "发布评论", reviewPublicNote: "评论会公开显示。请不要发布私人联系方式或敏感信息。", reviewAnonymous: "匿名",
