...
const PROGRAMME_ZH = {
  ...
  "fudan-english-taught-international-postgraduate":
    "复旦大学英文授课国际研究生项目",
  ...
  "pku-international-standard-graduate-admissions":
    "北京大学国际研究生常规招生",
  ...
  PROGRAMME_TRANSLATIONS = Object.fromEntries(
    Object.entries(entries)
      .map(([scopeId, value]) => {
        ...
        const aliasesZh = Array.isArray(value?.aliasesZh)
          ? value.aliasesZh
          : [];
...
const ROUND_ZH = {
  ...
  "Phase One": "第一阶段",
  "Phase Two": "第二阶段",
  "Regular admissions": "常规招生",
  "Regular deadline": "常规截止",
  "Second application round": "第二轮申请",
...
export function programmeLabel(scopeId, fallback, language = "en") {
  ...
  return (
    PROGRAMME_TRANSLATIONS[scopeId]?.zh || PROGRAMME_ZH[scopeId] || fallback
  );
}
